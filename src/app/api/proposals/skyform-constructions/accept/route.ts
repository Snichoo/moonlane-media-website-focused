...
const ACCEPTANCE_PATH = "/proposal/skyform-constructions";
const CLIENT_NAME = "Skyform Constructions Pty Ltd";
const DEPOSIT = "$4,000";
const MAX_BODY_BYTES = 8_192;
const PROPOSAL_ID = "skyform-constructions";
const PROPOSAL_VERSION = "28 August 2026";
const TOTAL_INVESTMENT = "$8,000";
const UUID_RE =

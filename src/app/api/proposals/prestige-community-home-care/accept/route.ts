...
const ACCEPTANCE_PATH = "/proposal/prestige-community-home-care";
const CLIENT_NAME = "Prestige Community Home Care";
const DEPOSIT = "$750";
const MAX_BODY_BYTES = 8_192;
const PROPOSAL_ID = "prestige-community-home-care";
const PROPOSAL_VERSION = "25 August 2026";

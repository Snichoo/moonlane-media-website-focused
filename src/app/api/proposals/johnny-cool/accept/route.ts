...
const ACCEPTANCE_PATH = "/proposal/johnny-cool";
const CLIENT_NAME = "Johnny Cool Refrigeration, Air-Conditioning & Electrical Pty Ltd";
const DEPOSIT = "$1,500";
const MAX_BODY_BYTES = 8_192;
const PROPOSAL_ID = "johnny-cool";
const PROPOSAL_VERSION = "31 August 2026";
const TOTAL_INVESTMENT = "$3,000";
const UUID_RE =
...
export async function POST(request: Request) {
  ...
  const html = `
    <div style="font-family:Arial,Helvetica,sans-serif;font-size:15px;color:#191919">
      ...
      <p style="margin:0 0 18px;color:#555">The Accept proposal button was selected on the ${escapeHtml(CLIENT_NAME)} proposal page. This notification does not verify the visitor's identity.</p>
  ...
  const text = [
    subject,
    "",
    `The Accept proposal button was selected on the ${CLIENT_NAME} proposal page. This notification does not verify the visitor's identity.`,
    "",

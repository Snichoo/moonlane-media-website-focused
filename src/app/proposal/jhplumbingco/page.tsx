...
const PROPOSAL_PATH = "/proposal/jhplumbingco";
...
export const metadata: Metadata = {
  title: {
    absolute: "Website Proposal for JHPLUMBINGCO | Moonlane Media",
  },
  description:
    "A website design and development proposal prepared by Moonlane Media for JHPLUMBINGCO.",
  alternates: {
  ...
  openGraph: {
    ...
    title: "Website Proposal for JHPLUMBINGCO",
    description:

...
import { DecodeTaxProposal } from "@/components/proposal/DecodeTaxProposal";
...
export const metadata: Metadata = {
  ...
  description:
    "A website design and development proposal prepared by Moonlane Media for Decode Tax Accountants.",
  alternates: {
  ...
  openGraph: {
    ...
    title: "Website Proposal for Decode Tax Accountants",
    description:
...
export default function DecodeTaxProposalPage() {
  return <DecodeTaxProposal />;
}

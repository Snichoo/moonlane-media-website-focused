...
const includedItems: ServiceItem[] = [
  ...
  {
    description: "Emergency plumbing, blocked drains, hot water and more.",
    icon: FileText,
    title: "Service pages",
  },
  {
...
export function UrgentPlumbingProposal() {
  ...
  const handleProposalAcceptance = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "/api/proposals/urgent-plumbing/accept",
        {
          body: JSON.stringify({
  ...
  return (
    <div className={`chr-content ${styles.proposal}`}>
      ...
      <main
        aria-label="Website proposal for Urgent Plumbing and Hot Water"
              ...
              <div className="chr-content-container">
                <div className={`home-banner-content ${styles.coverContent}`}>
                  ...
                  <h1 className="title" id="proposal-cover-title">
                    ...
                    <span className={styles.coverLine}>Urgent Plumbing</span>
                    <span className={`highlight ${styles.coverLine}`}>&amp; Hot Water</span>
                  </h1>
                  <p className={styles.coverLead}>
                    A fast, mobile-first website designed to turn urgent plumbing searches into phone calls.
                  </p>
                  <a
                    className="button"
                    href="#opportunity"
          ...
          >
            <div className="chr-content-container section-three-heading-part">
              ...
              <div className={`right-part wysiwyg-wrapper ${styles.opportunityCopy}`}>
                <p>
                  Urgent Plumbing &amp; Hot Water already has a strong, memorable
                  domain, but it does not currently present customers with a
                  finished website. Visitors cannot quickly see your services,
                  service area or the fastest way to contact you.
                </p>
                <p>
                  The new website will give Urgent Plumbing &amp; Hot Water a
                  credible, mobile-first presence, clearly present emergency
                  plumbing, blocked drains, hot water and leak-related services,
                  and make calling or requesting help immediate.
                </p>
              </div>
          ...
          >
            <div className="chr-content-container chr-text-and-image-container left-image">
              ...
              <div className="text-part wysiwyg-wrapper">
                ...
                <p>
                  Your domain can stay with its current registrar while the new
                  site is hosted on Vercel. Its free tier provides fast, secure
                  hosting for this project.
                </p>
                <ul>
                  <li>Your domain remains in your existing registrar account.</li>
                  <li>Your existing business email configuration remains unchanged.</li>
